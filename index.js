...
async function run() {
    try {
        ...
        const usersCollection = client.db("rs-sport-camp").collection("users");
        const classesCollection = client.db("rs-sport-camp").collection("classes");
        const selectedClassesCollection = client.db("rs-sport-camp").collection("selectedClasses");
        const paymentsCollection = client.db("rs-sport-camp").collection("payments");
...
app.get('/', (req, res) => {
    res.send('Sport camp is running')
})

app.listen(port, () => {
    console.log(`Sport camp is running on port ${port}`);
})